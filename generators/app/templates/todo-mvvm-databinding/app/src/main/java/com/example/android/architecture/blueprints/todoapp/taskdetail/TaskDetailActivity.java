...
import <%= appPackage %>.R;
import <%= appPackage %>.ViewModelHolder;
...
import static <%= appPackage %>.addedittask.AddEditTaskActivity.ADD_EDIT_RESULT_OK;
import static <%= appPackage %>.taskdetail.TaskDetailFragment.REQUEST_EDIT_TASK;
